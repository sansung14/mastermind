...
public class Intermedio extends JFrame implements MouseListener {
	...
	public Intermedio() {
		...
		layeredPane.setBounds(588, 60, 270, 62);
		...
		textField_44.setBounds(218, 11, 42, 38);
		...
		textField_40.addMouseListener(this);
	...
	public static void randomColors() {
		...
		textField_44.setBackground(colores[4]);
